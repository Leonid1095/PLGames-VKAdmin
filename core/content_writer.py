...
def _build_system_prompt(ctx: dict, instruction: str = "") -> str:
    ...
    return (
        ...
        f"{tone_hint} "
        "СТРОГИЕ ПРАВИЛА:\n"
        "- Пиши ТОЛЬКО на основе предоставленного материала. НЕ ВЫДУМЫВАЙ факты, цифры, названия или события\n"
        "- Если в материале мало информации — пиши короткий пост (5-7 предложений), НЕ ДОПОЛНЯЙ от себя\n"
        ...
        "- Каждый пост должен быть УНИКАЛЬНЫМ. Не повторяй одни и те же фразы-шаблоны."
    )
