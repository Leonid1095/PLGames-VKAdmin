        ...
        for item in items[:3]:
            ...
            rewritten = await generate_response(
                prompt=f"Вот исходная новость:\n\n{raw_text}\n\n"
                       f"Перепиши для поста ВКонтакте. Можно использовать эмодзи. "
                       f"3-5 предложений. Пиши грамотным русским языком.",
                system_prompt="Ты SMM-специалист. Перепиши новость своими словами для поста ВКонтакте. "
                              "Пиши грамотным, естественным русским языком. Можно добавить эмодзи. "
                              "Не повторяй одно и то же. Никогда не добавляй хэштеги (символ #). 3-5 предложений.",
                group_id=group_id,
            )
